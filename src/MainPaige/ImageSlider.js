...
const ImageSlider = ({ images }) => { // takes in images as props
    ...
    const caption = () => {
        ...
        if (index === 2) {
            return (
                <p>We all know the rail at your high school is amazing, but there still might be a better one out there right? With ride spot you can find that new rail and much more. Sort through our communities list of spots by sport, difficulty, and security level to discover your new favorite place to hurt yourself.</p>
            )
        }
    }
